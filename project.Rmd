...
params <- tibble(
      ...
      MeOH.d13C = -46.2, meS.d13C = 0, CO2.d13C = -8, CH4.d13C = 0, actCoA.d13C = 0, lipids.d13C = 0, obio.d13C = 0, #CO2 = compressed gas so atmospheric
...
steady2 <- path_methanogen %>%
  set_parameters(scenario = c("loads biomass", "less biomass"),
